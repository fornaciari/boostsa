...
class Bootstrap:
    ...
    def metrics(targs, h0_preds, h1_preds, h0_name='h0', h1_name='h1', verbose=False):
        ...
        if verbose:
            ...
            print(f"{'h0 preds count:':<25} {h0_countpreds}")
            print(f"{'h1 preds count:':<25} {h1_countpreds}")
            print(f"{'h0 F-measure':.<25} {h0_f1:<8} {'h1 F-measure':.<30} {h1_f1:<8} {'diff':.<7} {diff_f1}")
            print(f"{'h0 accuracy':.<25} {h0_acc:<8} {'h1 accuracy':.<30} {h1_acc:<8} {'diff':.<7} {diff_acc}")
            print(f"{'h0 precision':.<25} {h0_prec:<8} {'h1 precision':.<30} {h1_prec:<8} {'diff':.<7} {diff_prec}")
            print(f"{'h0 recall':.<25} {h0_rec:<8} {'h1 recall':.<30} {h1_rec:<8} {'diff':.<7} {diff_rec}")
    ...
    def test(self, targs, h0_preds, h1_preds, h0_name='h0', h1_name='h1', n_loops=100, perc_sample=.1, verbose=False):
        ...
        print(f"{'total size':.<20} {overall_size}\n{'sample size':.<20} {sample_size}")
